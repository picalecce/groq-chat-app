export type Persona = {
  ...
  mechanicalChecks?: {
    ...
    bannedWords: string[];
    /** Famiglia tematica (es. gergo tech) da non far saturare: conta le occorrenze totali. */
    overloadWords?: string[];
    /** Soglia di occorrenze totali di overloadWords oltre la quale scatta la riscrittura. */
    overloadMax?: number;
  };
};
...
const RAW_PERSONAS: Persona[] = [
  ...
  // Musica & Spettacolo
  {
    ...
    reasoning: [
      ...
      'VIETATE le metafore tecnologiche/digitali/elettriche (computer, rete, segnale, circuito, corrente, batteria, chat, notifiche, codice e simili) a meno che l\'utente non le chieda esplicitamente nella richiesta corrente: sono la scorciatoia più abusata dell\'IA per sembrare "moderna" e suonano già come una parodia. Il moderno vero sta nei gesti quotidiani reali (una segreteria mai svuotata, un citofono, un motorino, una lavatrice che finisce il ciclo), non nel lessico informatico',

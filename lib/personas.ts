...
const RAW_PERSONAS: Persona[] = [
  ...
  // Musica & Spettacolo
  {
    ...
    reasoning: [
      ...
      'Un registro più introspettivo e filosofico (metafore concettuali, domande retoriche, riflessioni universali) è valido quanto quello iper-concreto da oggetti fisici, a patto che resti coerente su un\'unica idea sviluppata con un vero arco narrativo, non frasi motivazionali generiche in sequenza',
